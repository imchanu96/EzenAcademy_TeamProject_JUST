...
(
	-- 경력 번호
	CARRER_NUMBER number NOT NULL,
	-- 입사일
	CARRER_BEGIN_DATE date,
	-- 퇴사일
	CARRER_END_DATE date,
	-- 회사명
	CARRER_NAME varchar2(4000),
	-- 직위
	CARRER_POSITION varchar2(4000),
	-- 소재지
	CARRER_LOCATION varchar2(4000),
	-- 담당 업무
	CARRER_JOB varchar2(4000),
	-- 이력서 번호
	RESUME_NUMBER number NOT NULL,
	PRIMARY KEY (CARRER_NUMBER)
);
...
(
	...
	-- 전공
	EDUCATION_POSITION varchar2(4000),
	-- 학점
	EDUCATION_GRADE varchar2(4000),
	-- 소재지
	EDUCATION_LOCATION varchar2(4000),
	-- 졸업 구분
	EDUCATION_READUATE varchar2(100),
	-- 이력서 번호
	RESUME_NUMBER number NOT NULL,
...
COMMENT ON TABLE CARRER IS '경력';
COMMENT ON COLUMN CARRER.CARRER_NUMBER IS '경력 번호';
COMMENT ON COLUMN CARRER.CARRER_BEGIN_DATE IS '입사일';
COMMENT ON COLUMN CARRER.CARRER_END_DATE IS '퇴사일';
COMMENT ON COLUMN CARRER.CARRER_NAME IS '회사명';
COMMENT ON COLUMN CARRER.CARRER_POSITION IS '직위';
COMMENT ON COLUMN CARRER.CARRER_LOCATION IS '소재지';
COMMENT ON COLUMN CARRER.CARRER_JOB IS '담당 업무';
COMMENT ON COLUMN CARRER.RESUME_NUMBER IS '이력서 번호';
...
COMMENT ON COLUMN EDUCATION.EDUCATION_POSITION IS '전공';
COMMENT ON COLUMN EDUCATION.EDUCATION_GRADE IS '학점';
COMMENT ON COLUMN EDUCATION.EDUCATION_LOCATION IS '소재지';
COMMENT ON COLUMN EDUCATION.EDUCATION_READUATE IS '졸업 구분';

...
public class PersonalMemberDto {
	...
	public PersonalMemberDto(int pNo, String pName, String pId, String pPwd, String pPhoneNum, String pCom,
			String pNickname, String pProfile, String pEmail, Date pHireDate, String pKeyword, String pTemporarily) {
		super();
		this.pNo = pNo;
		this.pName = pName;
		this.pId = pId;
	...
	public String toString() {
		return "PersonalMemberDto [pNo=" + pNo + ", pName=" + pName + ", pId=" + pId + ", pPwd=" + pPwd + ", pPhoneNum="
				+ pPhoneNum + ", pCom=" + pCom + ", pNickname=" + pNickname + ", pProfile=" + pProfile + ", pEmail="
				+ pEmail + ", pHireDate=" + pHireDate + ", pKeyword=" + pKeyword + ", pTemporarily=" + pTemporarily
				+ "]";
	}

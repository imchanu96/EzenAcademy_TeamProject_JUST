package com.jobhub.review.util;

import java.io.Serializable;

public class CompanyMemberPaging implements Serializable {

	public static final int PAGE_SCALE = 5;		// 한 페이지당 기업 수
	public static final int BLOCK_SCALE = 10;	// 페이징 몇 페이지부터 몇 페이지까지 보여주고 화살표처리 할건지
	...
	public CompanyMemberPaging(int count, int curPage) {
		this.curBlock = 1;
